...
export default function EarnPage() {
  const [referralCode, _setReferralCode] = useState("YOUR-CODE");
  const _referralUrl = `https://litlabs-evlla8c7n-larry-bols-projects.vercel.app/auth?ref=${referralCode}`;
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-slate-700 bg-slate-900/60 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <label className="block text-sm font-medium mb-2">Free Referrals/Month</label>
              <input
                type="number"
                defaultValue={10}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Paid Conversions (20%)</label>
              <input
                type="number"
                defaultValue={2}
                className="w-full px-4 py-2 rounded-lg bg-slate-800 border border-slate-700"
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Avg. Plan ($49)</label>
              <input
                type="number"
                defaultValue={49}
                className="w-full px-4 py-2 rounded-lg bg-slate-800 border border-slate-700"
