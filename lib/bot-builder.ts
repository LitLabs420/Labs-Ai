 ...
 */
export async function testBot(_botId: string, _query: string): Promise<string> {
 ...
 * Get bot analytics
 */
export async function getBotAnalytics(_botId: string): Promise<BotConfig['analytics']> {
